...
checks = [
    (
        "_stream_inline_fast"
        not in content[
            content.find("async def _generate_tarot_inline") : content.find("def _build_tarot_system_prompt")
        ],
    ...
    (
        "is_error_message"
        in content[content.find("async def _generate_tarot_inline") : content.find("def _build_tarot_system_prompt")],
