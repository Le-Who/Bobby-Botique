...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--max-warmup-ms", type=float, default=None, help="Fail if catalog warmup exceeds this many ms.")
    parser.add_argument("--max-search-ms", type=float, default=None, help="Fail if any release city search exceeds this many ms.")
