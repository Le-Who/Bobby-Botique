...
- **Inline Mode**
  ...
  - _Expected Outcome_: Full AI answer (with fresh web context) appears in the original chat, in-place, within ~5–15 s (min of 3 parallel key latencies). On all-rounds failure, user can retry with one tap (`🔄 Повторить`, 5-min TTL).
