...
## 2024-05-18 - Missing ARIA Labels on Tab Panels
**Learning:** Tab panels need an aria-labelledby attribute pointing to the ID of the corresponding tab button for proper screen reader support, and dynamic badges need aria-live="polite" and aria-atomic="true" to announce updates.
**Action:** Add id to tab buttons and aria-labelledby to tab panels. Add aria-live and aria-atomic to dynamic badges.
