...
async def run_bot_with_retry():
    ...
    try:
        ...
        from app.handlers.inline import (
            handle_chosen_inline_result,
            handle_inline_query,
            handle_inline_retry_callback,
        )

        application.add_handler(InlineQueryHandler(handle_inline_query))
        application.add_handler(ChosenInlineResultHandler(handle_chosen_inline_result))
        application.add_handler(CallbackQueryHandler(handle_inline_retry_callback, pattern=r"^inl_retry:"))
