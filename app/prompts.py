...
PROMPT_ENGINEER_SYSTEM_PROMPT = (
    ...
    "Твоя задача — преобразовать описание задачи пользователя в безопасную и структурированную роль (system prompt) с чёткими полями. "
