...
from app.repos.user_stats import get_user_activity_summary, get_user_today_request_count
...
async def get_start_menu_content(chat_state, user_id=None):
    ...
    if user_id:
        try:
            ...
            req_count = activity["req_count"]
            doc_count = activity["doc_count"]
            conv_count = activity["conv_count"]
