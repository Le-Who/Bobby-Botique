...
async def stats_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # ⚡ Bolt: Consolidated activity stats into a single query to prevent N+1 query patterns
    # and avoid fetching full document contents into memory just to count them.
