    ...
    return [
        ReportSection(
            ...
            body_markdown=(
                ...
                "Например, этот блок заметен в момент выбора: вы можете повторить привычную защиту, а можете собрать "
                "центр и действовать взрослее, чем раньше. Тень центра включается, когда сильное качество становится "
        ...
        ReportSection(
            ...
            body_markdown=(
                ...
                f"{comfort.interpretation}. Это не про пассивный отдых, а про способ снова стать собраннее.\n\n"
        ...
        ReportSection(
            ...
            body_markdown=(
                ...
                f"ждать более красивого момента. Тень поиска себя — бесконечно готовиться к жизни, вместо того "
        ...
        ReportSection(
            ...
            body_markdown=(
                f"Энергетический ритм матрицы показывает не медицинскую картину, а то, как вы расходуете внимание, "
